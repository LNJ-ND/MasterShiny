...
fRL_model = function(stage, stimulus, f1, f2, f3, f4, alpha_pos, alpha_neg, beta) {
  ...
  # Choose alpha based on choice
  alpha = ifelse(choice == 1, alpha_pos, alpha_neg)
...
cafRL_model = function(stage, stimulus, f1, f2, f3, f4, alpha_pos, alpha_neg, beta, theta) {
    ...
    for (stage in 1:n_stages) {
      ...
      for (t in 1:n_trials) {
        ...
        if (model == "fRL") { 
          ...
          out = fRL_model(stage, stimulus_vector[t], f1_vector[t], f2_vector[t], f3_vector[t], f4_vector[t], alpha_pos, alpha_neg, beta)
          
        } else if (model == "cafRL") {
          
          out = cafRL_model(stage, stimulus_vector[t], f1_vector[t], f2_vector[t], f3_vector[t], f4_vector[t], alpha_pos, alpha_neg, beta, theta_vector[t])
